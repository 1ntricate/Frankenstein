...
define gui.idle_color = '#ece9e9'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#f1b5b5'
...
define gui.interface_text_font = "Doctor_Glitch.ttf"
...
##image maineMenu = Movie(play="gui/main_menu.ogv")
define gui.main_menu_background = Movie(size=(1920, 1080), play="gui/main_menu.ogv")
